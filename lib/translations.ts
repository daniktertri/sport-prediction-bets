...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  fr: {
    ...
    'common.createAccountToPredict': 'Créez un compte pour commencer à faire des prédictions',
    ...
    'matchDetail.betDistribution': 'Répartition des prédictions (1/N/2)',
    'matchDetail.noBetsYet': 'Aucune prédiction sur ce match pour le moment.',
    'matchDetail.yourBetResult': 'Résultat de votre prédiction',
    ...
    'matchDetail.loginToSeeStats': 'Connectez-vous pour voir vos statistiques de prédictions.',
    ...
    'leaderboard.pts': 'pts',
    'leaderboard.hallOfShame': 'Prédicteurs avec la pire vista',
    'leaderboard.shameDescription': 'Les prédicteurs les moins inspirés... mais au moins ils essaient !',
    'leaderboard.bets': 'prédictions',
    'leaderboard.ptsPerBet': 'pts/prédiction',
    // Profile
    ...
    // My Bets
    'common.myBets': 'Mes Prédictions',
    'myBets.title': 'Mes Prédictions',
    'myBets.subtitle': 'Historique de toutes vos prédictions',
    'myBets.totalBets': 'Total Prédictions',
    'myBets.won': 'Gagnés',
    'myBets.lost': 'Perdus',
    'myBets.noBets': 'Vous n\'avez pas encore fait de prédictions. Commencez à prédire les matchs !',
  ...
  en: {
    ...
    'common.createAccountToPredict': 'Create an account to start predicting',
    ...
    'matchDetail.betDistribution': 'Prediction distribution (1/X/2)',
    'matchDetail.noBetsYet': 'No predictions on this match yet.',
    'matchDetail.yourBetResult': 'Your Prediction Result',
    ...
    'matchDetail.loginToSeeStats': 'Log in to see your prediction stats.',
    ...
    'leaderboard.shameDescription': 'The least inspired predictors... but at least they\'re trying!',
    'leaderboard.bets': 'predictions',
    'leaderboard.ptsPerBet': 'pts/prediction',
    // Profile
    ...
    // My Bets
    'common.myBets': 'My Predictions',
    'myBets.title': 'My Predictions',
    'myBets.subtitle': 'History of all your predictions',
    'myBets.totalBets': 'Total Predictions',
    'myBets.won': 'Won',
    'myBets.lost': 'Lost',
    'myBets.noBets': 'You haven\'t made any predictions yet. Start predicting matches!',
